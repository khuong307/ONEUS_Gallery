...
//        }
        ...
        if (cameraDirectory.exists()){
            ...
            for (int i = 0; i < cameraSubFolder.length; i++){
                ...
                if (checkDiffImage(bmps, bmp)){
                    bmps.add(bmp);
                    imageList.add(new Image(cameraSubFolder[i], cameraSubFolder[i].getName()));
                }
            }
        }
        ...
        if (downloadDirectory.exists()){
            ...
            for (int i = 0; i < downloadSubFolder.length; i++){
                ...
                if (checkDiffImage(bmps, bmp)){
                    bmps.add(bmp);
                    imageList.add(new Image(downloadSubFolder[i], downloadSubFolder[i].getName()));
                }
            }
        }
        ...
        if (albumDirectory.exists()){
            ...
            for (int i = 0; i < albumSubFolder.length; i++){
                ...
                for (int j = 0; j < tmp.length; j++){
                    ...
                    if (checkDiffImage(bmps, bmp)){
                        bmps.add(bmp);
                        imageList.add(new Image(tmp[j], tmp[j].getName()));
                    }
                }
            }
        }
